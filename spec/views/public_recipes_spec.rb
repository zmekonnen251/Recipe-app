...
RSpec.describe 'The public recipes page', type: :feature do
  before :each do
    ...
    @recipe1 = Recipe.create!(name: 'Test Recipe 1', description: 'test decription 1', public: true, preparation_time: 20.0, cooking_time: 40.0,
                              user_id: @user1.id)

    @recipe2 = Recipe.create!(name: 'Test Recipe 2', description: 'test decription 2', public: false, preparation_time: 20.0, cooking_time: 40.0,
                              user_id: @user1.id)
  end
